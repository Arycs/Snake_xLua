...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public FoodMaker __Gen_Delegate_Imp0()
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                FoodMaker __gen_ret = (FoodMaker)translator.GetObject(L, errFunc + 1, typeof(FoodMaker));
		...
		public void __Gen_Delegate_Imp2(object p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
